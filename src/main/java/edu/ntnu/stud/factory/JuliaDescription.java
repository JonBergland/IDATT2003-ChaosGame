...
public class JuliaDescription extends ChaosGameDescription {
   ...
   */
  public JuliaDescription(List<Transform2D> transforms, Vector2D minCoords, Vector2D maxCoords) {
    super(transforms, minCoords, maxCoords); // TODO - implement JuliaDescription
  }
}
